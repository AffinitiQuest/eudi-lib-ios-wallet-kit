...
let package = Package(
    ...
    .package(url: "https://github.com/apple/swift-log.git", from: "1.5.3"),
		...
		.package(url: "https://github.com/AffinitiQuest/eudi-lib-ios-iso18013-data-transfer.git", branch: "aq-dev"),
		//.package(path: "../eudi-lib-ios-iso18013-data-transfer"),
		.package(url: "https://github.com/AffinitiQuest/eudi-lib-ios-wallet-storage.git", branch: "aq-dev"),
    .package(url: "https://github.com/eu-digital-identity-wallet/eudi-lib-sdjwt-swift.git", exact: "0.5.1"),
		.package(url: "https://github.com/AffinitiQuest/eudi-lib-ios-siop-openid4vp-swift.git", branch: "aq-dev"),
		.package(url: "https://github.com/AffinitiQuest/eudi-lib-ios-openid4vci-swift.git", branch: "aq-dev"),
	],
    targets: [
